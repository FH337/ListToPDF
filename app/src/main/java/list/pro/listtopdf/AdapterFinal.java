...
public class AdapterFinal extends RecyclerView.Adapter<AdapterFinal.Holder> {

    private List<Data> listData;
    private Context mContext;


    public AdapterFinal(List<Data> listData, Context mContext) {
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType){
        View item = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.finalitemlist,parent,false);
